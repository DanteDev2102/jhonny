...
!(function (e, t) {
	...
	function p(e, t) {
		...
		if (-1 !== o) {
			...
			if (
				(void 0 === i &&
					((i = {}),
					(n.__rememberedObjectIndecesToControllers[o] =
						i)),
				(i[t.property] = t),
	...
	var U = /(\d+(\.\d+)?)px/,
		X = {
			...
			isActive: function (e) {
				return (
					e === document.activeElement && (e.type || e.href)
				);
			}
		},
		K = (function (e) {
		...
		q = (function (e) {
			function t(e, n, o, i, r) {
				...
				function d(e) {
					...
					_.setValue(
						a(t, n.left, n.right, _.__min, _.__max)
					);
				}
				function c() {
			...
			function t(e, n) {
				...
				function u(e) {
					-1 === e.type.indexOf('touch') &&
						e.preventDefault();
					var t =
							p.__saturation_field.getBoundingClientRect(),
				...
				(h.domElement = document.createElement('div')),
					...
					(h.__saturation_field.className =
						'saturation-field'),
				...
				return (
					...
					S.extend(h.__input.style, {
						...
						fontWeight: 'bold',
						textShadow:
							h.__input_textShadow + 'rgba(0,0,0,0.7)'
					}),
		...
		he = function e(t) {
			...
			(this.domElement = document.createElement('div')),
				...
				S.isUndefined(o.parent) &&
					...
					_e.push(this),
				(o.resizable =
					S.isUndefined(o.parent) && o.resizable),
				o.autoPlace &&
			...
			var i =
					ae &&
					'true' ===
						localStorage.getItem(m(this, 'isLocal')),
				r = void 0,
				s = void 0;
			if (
			...
			o.autoPlace &&
				...
				(r = function () {
					ae &&
						'true' ===
							localStorage.getItem(m(n, 'isLocal')) &&
						localStorage.setItem(
							m(n, 'gui'),
